...
import styles from './domainTools.module.css';
        ...
        <div className="container">
            <div className="row">
                <div className={`col-md-8 ${styles.main_area}`}>
                    <h1 className={`col-12 mt-2 ${styles.main_heading}`}>Proxy Tools</h1>
                    <div className={`col-12 ${styles.heading_paragraph}`}>
                        <p>Use proxy tools to know your IP location or to get a free daily proxy list</p>
                    </div>
                </div>
            </div>
